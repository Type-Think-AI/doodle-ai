 ...
 * `slug` no longer matches the page anchor — re-verify against the rendered
 * HTML and refresh `SLUG_STRIP` from `node_modules/github-slugger/regex.js`.
 */

/* -------------------------------------------------------------------------- */
/* Slug — vendored github-slugger@2.0.0                                        */
/* -------------------------------------------------------------------------- */
...
export function slugify(value: string): string {
  return value.toLowerCase().replace(SLUG_STRIP, "").replace(/ /g, "-");
}
